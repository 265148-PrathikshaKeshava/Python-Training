from manage import Employee, Department, load_from_json, save_to_json
# -----------------------
...
# Save Data
save_to_json(employees, json_path=r"C:\Users\265148\Desktop\New folder\Hackathon02\Employee.json")

# Load and verify
print("\n📂 Loaded Data from JSON:")
loaded_emps = load_from_json(json_path=r"C:\Users\265148\Desktop\New folder\Hackathon02\Employee.json") # Should take data from json, create employee objects and return the list 
