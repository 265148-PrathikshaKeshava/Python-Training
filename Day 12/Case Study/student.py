...
f = open(r'C:\Users\265148\Desktop\New folder\Day 12\Case Study\studentdata.csv','r')
content = f.readlines()
f.close()
...
#RANK.TXT creation and appending
with open(r"C:\Users\265148\Desktop\New folder\Day 12\Case Study\rank.txt", "w") as file:
...
#Student.csv creation and appending
with open(r"C:\Users\265148\Desktop\New folder\Day 12\Case Study\student.csv", "w") as file:
